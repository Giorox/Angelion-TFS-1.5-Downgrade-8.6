...
keywordHandler:addKeyword({'tibia'}, StdModule.say, {npcHandler = npcHandler, text = "Hehe, do you have a shovel? I can sell you a shovel if you want to return to Tibia."})
...
keywordHandler:addAliasKeyword({'fibula', 'dungeon'})
keywordHandler:addKeyword({'shovel'}, StdModule.say, {npcHandler = npcHandler, text = "Do you want to buy a shovel for 50 {gold}? Ask me for a trade."})
keywordHandler:addKeyword({'gold'}, StdModule.say, {npcHandler = npcHandler, text = "I need gold. I love gold. I need {help}."})
keywordHandler:addKeyword({'key'}, StdModule.say, {npcHandler = npcHandler, text = "Key? There are a lot of keys. Please change topic."})
...
keywordHandler:addKeyword({'giant', 'spider'}, StdModule.say, {npcHandler = npcHandler, text = "I know that terrible monster. It killed the fishers on the isle on north."})
keywordHandler:addKeyword({'minotaurs'}, StdModule.say, {npcHandler = npcHandler, text = "Very rich monsters. But they are too strong for me. However there are even strongers monsters."})
